...
// Trigger aktiv
#define ParamSOM_TriggerState              (bool)(knx.paramByte(SOM_ParamBlockOffset + _channelIndex * SOM_ParamBlockSize + SOM_TriggerState) & SOM_TriggerStateMask)
// Sperrobjekt
#define ParamSOM_TriggerLock               ((knx.paramByte(SOM_ParamBlockOffset + _channelIndex * SOM_ParamBlockSize + SOM_TriggerLock) & SOM_TriggerLockMask) >> SOM_TriggerLockShift)
// Tag/Nacht Objekt
#define ParamSOM_TriggerDayNight           ((knx.paramByte(SOM_ParamBlockOffset + _channelIndex * SOM_ParamBlockSize + SOM_TriggerDayNight) & SOM_TriggerDayNightMask) >> SOM_TriggerDayNightShift)
// Priorität
#define ParamSOM_TriggerPriority           ((knx.paramByte(SOM_ParamBlockOffset + _channelIndex * SOM_ParamBlockSize + SOM_TriggerPriority) & SOM_TriggerPriorityMask) >> SOM_TriggerPriorityShift)
// Zeitbasis
#define ParamSOM_TriggerDurationBase       ((knx.paramByte(SOM_ParamBlockOffset + _channelIndex * SOM_ParamBlockSize + SOM_TriggerDurationBase) & SOM_TriggerDurationBaseMask) >> SOM_TriggerDurationBaseShift)
// Zeit
#define ParamSOM_TriggerDurationTime       (knx.paramWord(SOM_ParamBlockOffset + _channelIndex * SOM_ParamBlockSize + SOM_TriggerDurationTime) & SOM_TriggerDurationTimeMask)
// Datei
#define ParamSOM_TriggerFileDay            (knx.paramWord(SOM_ParamBlockOffset + _channelIndex * SOM_ParamBlockSize + SOM_TriggerFileDay))
// Datei
#define ParamSOM_TriggerFileNight          (knx.paramWord(SOM_ParamBlockOffset + _channelIndex * SOM_ParamBlockSize + SOM_TriggerFileNight))
// Lautstärke
#define ParamSOM_TriggerVolumeDay          (knx.paramByte(SOM_ParamBlockOffset + _channelIndex * SOM_ParamBlockSize + SOM_TriggerVolumeDay))
// Lautstärke
#define ParamSOM_TriggerVolumeDayInactive  (knx.paramByte(SOM_ParamBlockOffset + _channelIndex * SOM_ParamBlockSize + SOM_TriggerVolumeDayInactive))
// Lautstärke
#define ParamSOM_TriggerVolumeNight        (knx.paramByte(SOM_ParamBlockOffset + _channelIndex * SOM_ParamBlockSize + SOM_TriggerVolumeNight))
// Lautstärke
#define ParamSOM_TriggerVolumeNightInactive (knx.paramByte(SOM_ParamBlockOffset + _channelIndex * SOM_ParamBlockSize + SOM_TriggerVolumeNightInactive))
// 
#define ParamSOM_TriggerRepeats            (knx.paramWord(SOM_ParamBlockOffset + _channelIndex * SOM_ParamBlockSize + SOM_TriggerRepeats))
// 
#define ParamSOM_TriggerRepeatsInactive    (knx.paramWord(SOM_ParamBlockOffset + _channelIndex * SOM_ParamBlockSize + SOM_TriggerRepeatsInactive))

// Communication objects per channel (multiple occurrence)
#define SOM_KoOffset 50
#define SOM_KoBlockSize 4
#define SOM_KoCalcIndex(number)  (((number - SOM_KoOffset) == (_channelIndex * SOM_KoBlockSize)) ? (number - SOM_KoOffset) % SOM_KoBlockSize : -1)
...
// Trigger%C%Trigger
#define KoSOM_TriggerTrigger            knx.getGroupObject(SOM_KoOffset + _channelIndex * SOM_KoBlockSize + SOM_KoTriggerTrigger)
// Trigger%C%Status
#define KoSOM_TriggerStatus             knx.getGroupObject(SOM_KoOffset + _channelIndex * SOM_KoBlockSize + SOM_KoTriggerStatus)
// Trigger%C%Lock
#define KoSOM_TriggerLock               knx.getGroupObject(SOM_KoOffset + _channelIndex * SOM_KoBlockSize + SOM_KoTriggerLock)
// Trigger%C%DayNight
#define KoSOM_TriggerDayNight           knx.getGroupObject(SOM_KoOffset + _channelIndex * SOM_KoBlockSize + SOM_KoTriggerDayNight)
...
// Aktiv
#define ParamBI_ChannelActive             (bool)(knx.paramByte(BI_ParamBlockOffset + _channelIndex * BI_ParamBlockSize + BI_ChannelActive) & BI_ChannelActiveMask)
// Geöffnet
#define ParamBI_ChannelOpen               ((knx.paramByte(BI_ParamBlockOffset + _channelIndex * BI_ParamBlockSize + BI_ChannelOpen) & BI_ChannelOpenMask) >> BI_ChannelOpenShift)
// Geschlossen
#define ParamBI_ChannelClose              ((knx.paramByte(BI_ParamBlockOffset + _channelIndex * BI_ParamBlockSize + BI_ChannelClose) & BI_ChannelCloseMask) >> BI_ChannelCloseShift)
// Zyklisch senden
#define ParamBI_ChannelPeriodic           (bool)(knx.paramByte(BI_ParamBlockOffset + _channelIndex * BI_ParamBlockSize + BI_ChannelPeriodic) & BI_ChannelPeriodicMask)
// Entprellung
#define ParamBI_ChannelDebouncing         (knx.paramByte(BI_ParamBlockOffset + _channelIndex * BI_ParamBlockSize + BI_ChannelDebouncing))
// Zeitbasis
#define ParamBI_ChannelPeriodicBase       ((knx.paramByte(BI_ParamBlockOffset + _channelIndex * BI_ParamBlockSize + BI_ChannelPeriodicBase) & BI_ChannelPeriodicBaseMask) >> BI_ChannelPeriodicBaseShift)
// Zeit
#define ParamBI_ChannelPeriodicTime       (knx.paramWord(BI_ParamBlockOffset + _channelIndex * BI_ParamBlockSize + BI_ChannelPeriodicTime) & BI_ChannelPeriodicTimeMask)

// Communication objects per channel (multiple occurrence)
#define BI_KoOffset 41
#define BI_KoBlockSize 1
#define BI_KoCalcIndex(number)  (((number - BI_KoOffset) == (_channelIndex * BI_KoBlockSize)) ? (number - BI_KoOffset) % BI_KoBlockSize : -1)
#define BI_KoChannelOutput 0


// Channel%C%Output
#define KoBI_ChannelOutput             knx.getGroupObject(BI_KoOffset + _channelIndex * BI_KoBlockSize + BI_KoChannelOutput)
...
//   Wert beim Loslassen
#define ParamBTN_ChannelOutputShort_Taster1_Active_Release (bool)(knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Active_Release) & BTN_ChannelOutputShort_Taster1_Active_ReleaseMask)
//   Wert beim Drücken
